...
Try {
	...
	[string]$appVendor = 'The ShareX Team'
	[string]$appName = 'ShareX'
	...
	[string]$installName = 'ShareX Installation'
	[string]$installTitle = 'ShareX'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'ShareX' -CheckDiskSpace -PersistPrompt -CloseAppsCountdown 600
		...
		[string]$MyArguments = "-ExecutionPolicy Bypass -NoLogo -File `"$dirFiles\InstallShareX.ps1`" "
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'ShareX' -CloseAppsCountdown 600
		...
		$AppList = Get-InstalledApplication -Name 'ShareX'
