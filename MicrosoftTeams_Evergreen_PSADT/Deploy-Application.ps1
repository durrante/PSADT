...
Try {
	...
	[string]$appScriptDate = '08/06/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'Teams' -CheckDiskSpace -PersistPrompt -CloseAppsCountdown 600
		...
		[string]$MyArguments = "-ExecutionPolicy Bypass -NoLogo -File `"$dirFiles\InstallMSTeamsSystemWide.ps1`" "
