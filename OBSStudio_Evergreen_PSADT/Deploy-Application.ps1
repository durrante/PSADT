...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'obs32,obs64' -CheckDiskSpace -PersistPrompt -CloseAppsCountdown 600
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'obs32,obs64' -CloseAppsCountdown 600
		...
		$AppList = Get-InstalledApplication -Name 'OBS Studio'        
