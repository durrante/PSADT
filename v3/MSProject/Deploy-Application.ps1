...
Try {
	...
	[string]$appScriptDate = '25/11/2021'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Show-InstallationWelcome -CloseApps 'excel,groove,onenote,outlook,mspub,powerpnt,winword,iexplore,visio,winproj' -CheckDiskSpace -PersistPrompt		
		...
		Execute-Process -Path "$dirFiles\setup.exe" -Parameters "/CONFIGURE AddProject.xml"
