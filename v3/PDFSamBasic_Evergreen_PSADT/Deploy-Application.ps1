...
Try {
    ...
    [String]$appVendor = 'Sober Lemur S.r.l.'
    [String]$appName = 'PDFSam Basic'
    ...
    [String]$installName = ''
    [String]$installTitle = 'PDFSam Basic'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'javaw,pdfsam' -CloseAppsCountdown 600
        ...
        Remove-MSIApplications -Name "PDFsam Basic"
		...
		Remove-File -Path "$envCommonDesktop\PDFsam Basic.lnk"
		
		## Delete Installer Files
		Remove-Item -Path $installerPath -Force

		## Remove uninstall shortcut
		Remove-File -Path "$envCommonStartMenuPrograms\PDFsam Basic\Uninstall.lnk"
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'javaw,pdfsam' -CloseAppsCountdown 60
