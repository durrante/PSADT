...
function Install-ADTDeployment
{
		...
		Show-ADTInstallationWelcome -CloseProcesses 'notepad++' -CheckDiskSpace -PersistPrompt -CloseProcessesCountdown 600
		...
		[string]$MyArguments = "-ExecutionPolicy Bypass -NoLogo -File `"$($adtSession.DirFiles)\InstallNotePadPlusPlus.ps1`" "
...
function Uninstall-ADTDeployment
{
		...
		Show-ADTInstallationWelcome -CloseProcesses 'Notepad++' -CloseProcessesCountdown 600
		...
		$AppList = Get-ADTApplication -Name 'Notepad++'
