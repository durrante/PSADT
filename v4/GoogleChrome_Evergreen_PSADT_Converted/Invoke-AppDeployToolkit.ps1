...
function Install-ADTDeployment
{
		...
		Show-ADTInstallationWelcome -CloseProcesses 'chrome' -CheckDiskSpace -PersistPrompt -CloseProcessesCountdown 600
		...
		$adtSession.AppName = "GoogleChrome"
		$appArchitecture = "x64"
		$appChannel = "Stable"
		$appType = "msi"
		...
		Start-Process -FilePath msiexec.exe -ArgumentList "/I `"$installerPath`" /quiet" -Wait -Verbose
		...
		Remove-ADTFile -Path "$envCommonDesktop\Google Chrome.lnk" -ErrorAction SilentlyContinue
...
function Uninstall-ADTDeployment
{
		...
		Show-ADTInstallationWelcome -CloseProcesses 'chrome' -CloseProcessesCountdown 600
