...
$adtSession = @{
    ...
    AppProcessesToClose = 'iexplore'  # Example: @('excel', @{ Name = 'winword'; Description = 'Microsoft Word' })
...
function Install-ADTDeployment
{
        ...
        ## Show Welcome Message, close Microsoft Word if required, allow up to 3 deferrals, verify there is enough disk space to complete the install, and persist the prompt
        # Show-InstallationWelcome -CloseApps 'winword=Microsoft Office Word' -CloseAppsCountDown 900 -PersistPrompt -BlockExecution -PromptToSave
		...
		Enable-WindowsOptionalFeature -Online -FeatureName NetFx3 -All -LimitAccess -Source $adtSession.DirFiles -NoRestart	
