...
$adtSession = @{
    ...
    AppProcessesToClose = 'ssms'  # Example: @('excel', @{ Name = 'winword'; Description = 'Microsoft Word' })
    ...
    InstallName = ''
    InstallTitle = 'Microsoft SQL Server Management Studio'
...
function Install-ADTDeployment
{
		...
		## Show Welcome Message, close SSMS if required after 10 minute countdown, verify there is enough disk space to complete the install, and persist the prompt
		Show-ADTInstallationWelcome -CloseProcesses 'ssms' -CheckDiskSpace -PersistPrompt -CloseProcessesCountdown 600
        ...
        Start-ADTProcess -FilePath "$ExePath" -ArgumentList "--quiet --norestart --wait" -WindowStyle Hidden
		...
		Remove-ADTFile -Path $Installer -ErrorAction SilentlyContinue 
...
function Uninstall-ADTDeployment
{
		...
		## Show Welcome Message, close SSMS with a 600 second countdown before automatically closing
		Show-ADTInstallationWelcome -CloseProcesses 'ssms' -CloseProcessesCountdown 600
