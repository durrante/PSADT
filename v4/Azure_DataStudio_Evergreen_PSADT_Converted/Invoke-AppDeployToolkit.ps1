...
$adtSession = @{
    # App variables.
    AppVendor = 'Microsoft'
    AppName = 'Azure Data Studio (System)'
    AppVersion = 'Latest'
    AppArch = 'x64'
    AppLang = 'EN'
    AppRevision = '1.0'
    ...
    AppProcessesToClose = @{ Name = 'azuredatastudio'; Description = 'Azure Data Studio' }  # Example: @('excel', @{ Name = 'winword'; Description = 'Microsoft Word' })
...
function Install-ADTDeployment
{
        ...
        Show-ADTInstallationWelcome -CloseProcesses @{ Name = 'azuredatastudio'; Description = 'Azure Data Studio' } -CloseProcessesCountdown 900 -PersistPrompt -BlockExecution -PromptToSave
        ...
        $AppList = Get-ADTApplication -Name 'Azure Data Studio'
		...
		$adtSession.AppName = "MicrosoftAzureDataStudio"
		...
		$appInfo = Get-EvergreenApp -Name $adtSession.AppName | Where-Object { $_.Platform -eq $appPlatform -and $_.Channel -eq $appChannel}
