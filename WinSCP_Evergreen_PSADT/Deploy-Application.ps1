...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'WinSCP' -CloseAppsCountDown 900 -PersistPrompt -PromptToSave
        ...
        Remove-MSIApplications -Name "WinSCP"
        ## Remove Any Existing Version of WinSCP (EXE)
        $AppList = Get-InstalledApplication -Name 'WinSCP'    
        ...
        Execute-Process -Path $UninstPath -Parameters "/VERYSILENT /NORESTART /LOG=""$configToolkitLogDir\WinSCP-Uninstall.log"""
