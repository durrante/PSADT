...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'code' -CheckDiskSpace -PersistPrompt -CloseAppsCountdown 600
		...
		Execute-ProcessAsUser -Path "$UninstPath" -Parameters "/VERYSILENT /NORESTART" -Wait
		...
		[string]$MyArguments = "-ExecutionPolicy Bypass -NoLogo -File `"$dirFiles\InstallVSCode.ps1`" "
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'Code' -CloseAppsCountdown 600
